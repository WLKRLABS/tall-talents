...
Note: Tall Talents now uses package directories. Ship each slug as `~/.tall-talents/talents/<slug>/TALENT.md` with a package-local `CHANGELOG.md`.
...
- Suggested internal files to create: `talents/design-before-build/TALENT.md`, `examples/design-before-build.md`, `templates/design-spec.md`
...
- Suggested internal files to create: `talents/implementation-planning/TALENT.md`, `examples/implementation-planning.md`, `templates/implementation-plan.md`
...
- Suggested internal files to create: `talents/plan-execution/TALENT.md`, `examples/plan-execution.md`
...
- Suggested internal files to create: `talents/subagent-task-loop/TALENT.md`, `examples/subagent-task-loop.md`, `templates/subagent-task.md`
...
- Suggested internal files to create: `talents/parallel-agent-dispatch/TALENT.md`, `examples/parallel-agent-dispatch.md`, `templates/parallel-dispatch.md`
...
- Suggested internal files to create: `talents/workflow-orchestration/TALENT.md`, `examples/workflow-orchestration.md`, `templates/pipeline-status.md`
...
- Suggested internal files to create: `talents/handoff-contracts/TALENT.md`, `examples/handoff-contracts.md`, `templates/handoff.md`
...
- Suggested internal files to create: `talents/systematic-debugging/TALENT.md`, `examples/systematic-debugging.md`
...
- Suggested internal files to create: `talents/test-first-delivery/TALENT.md`, `examples/test-first-delivery.md`
...
- Suggested internal files to create: `talents/verification-gate/TALENT.md`, `examples/verification-gate.md`, `templates/verification-checklist.md`
...
- Suggested internal files to create: `talents/code-review/TALENT.md`, `examples/code-review.md`, `templates/review-request.md`
...
- Suggested internal files to create: `talents/review-feedback-triage/TALENT.md`, `examples/review-feedback-triage.md`
...
- Suggested internal files to create: `talents/worktree-isolation/TALENT.md`, `examples/worktree-isolation.md`
...
- Suggested internal files to create: `talents/branch-finish-workflow/TALENT.md`, `examples/branch-finish-workflow.md`
...
- Suggested internal files to create: `talents/minimal-diff-execution/TALENT.md`, `examples/minimal-diff-execution.md`
...
- Suggested internal files to create: `talents/architecture-decisioning/TALENT.md`, `examples/architecture-decisioning.md`, `templates/adr.md`
...
- Suggested internal files to create: `talents/repo-onboarding-map/TALENT.md`, `examples/repo-onboarding-map.md`, `templates/orientation-map.md`
...
- Suggested internal files to create: `talents/documentation-pass/TALENT.md`, `examples/documentation-pass.md`, `templates/readme-outline.md`
...
- Suggested internal files to create: `talents/security-review/TALENT.md`, `examples/security-review.md`, `templates/threat-model.md`
...
- Suggested internal files to create: `talents/devops-automation/TALENT.md`, `examples/devops-automation.md`, `templates/pipeline-checklist.md`
...
- Suggested internal files to create: `talents/incident-response/TALENT.md`, `examples/incident-response.md`, `templates/post-mortem.md`
...
- Suggested internal files to create: `talents/release-readiness-audit/TALENT.md`, `examples/release-readiness-audit.md`, `templates/readiness-report.md`
...
- Suggested internal files to create: `talents/visual-evidence-qa/TALENT.md`, `examples/visual-evidence-qa.md`, `templates/qa-report.md`
...
- Suggested internal files to create: `talents/api-validation/TALENT.md`, `examples/api-validation.md`, `templates/api-test-matrix.md`
...
- Suggested internal files to create: `talents/performance-benchmarking/TALENT.md`, `examples/performance-benchmarking.md`, `templates/performance-report.md`
...
- Suggested internal files to create: `talents/product-requirements/TALENT.md`, `examples/product-requirements.md`, `templates/prd.md`
...
- Suggested internal files to create: `talents/sprint-prioritization/TALENT.md`, `examples/sprint-prioritization.md`, `templates/sprint-plan.md`
...
- Suggested internal files to create: `talents/feedback-synthesis/TALENT.md`, `examples/feedback-synthesis.md`, `templates/feedback-report.md`
...
- Suggested internal files to create: `talents/trend-research/TALENT.md`, `examples/trend-research.md`, `templates/trend-brief.md`
...
- Suggested internal files to create: `talents/ux-research/TALENT.md`, `examples/ux-research.md`, `templates/usability-findings.md`
...
- Suggested internal files to create: `talents/ux-foundation/TALENT.md`, `examples/ux-foundation.md`, `templates/ui-foundation.md`
...
- Suggested internal files to create: `talents/compliance-review/TALENT.md`, `examples/compliance-review.md`, `templates/compliance-scan.md`
...
- Suggested internal files to create: `talents/workflow-mapping/TALENT.md`, `examples/workflow-mapping.md`, `templates/workflow-tree.md`
...
- Suggested internal files to create: `talents/automation-governance/TALENT.md`, `examples/automation-governance.md`, `templates/automation-verdict.md`
...
- Suggested internal files to create: `talents/executive-briefing/TALENT.md`, `examples/executive-briefing.md`, `templates/executive-brief.md`
...
Tall Talents now operates as a package-based live library. The recommended plan below is therefore package-oriented:

- Draft in category folders during acquisition.
- Activate into package directories using the same slugs under `~/.tall-talents/talents/`.
...
- `~/.tall-talents/talents/design-before-build/TALENT.md`
- `~/.tall-talents/talents/implementation-planning/TALENT.md`
