...
BOOTSTRAP_BASE="${TALL_TALENTS_BOOTSTRAP_BASE:-https://raw.githubusercontent.com/WLKRLABS/tall-talents/${TALL_TALENTS_REF}/bootstrap}"
SCRIPT_BASE="${TALL_TALENTS_SCRIPT_BASE:-https://raw.githubusercontent.com/WLKRLABS/tall-talents/${TALL_TALENTS_REF}/scripts}"
